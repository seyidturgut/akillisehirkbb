            ...
            <div className="relative z-10 w-full flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="flex-1 grid grid-cols-2 gap-8">
                    <div className="p-8 bg-white/5 rounded-[2rem] border border-white/10 flex flex-col items-center justify-center text-center">
                        ...
                        <span className="text-xs text-gray-500 font-bold uppercase tracking-widest">Air Quality Index</span>
                    </div>
                    ...
                    <div className="p-8 bg-white/5 rounded-[2rem] border border-white/10 flex flex-col items-center justify-center text-center">
                        ...
                        <span className="text-xs text-gray-500 font-bold uppercase tracking-widest">{data.traffic.status} Traffic</span>
                    </div>
                </div>
                ...
                <div className="w-full md:w-96 flex flex-col gap-6">
                    <div className="p-8 bg-white/10 rounded-[2rem] border border-white/20 shadow-2xl">
                        <h3 className="text-xl font-bold text-white mb-6">Live City Snapshot</h3>
